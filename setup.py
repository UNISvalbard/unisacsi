...
requirements = ['matplotlib==3.5', 'glob', 'seabird','numpy','scipy','pandas', 'geopandas', 'shapely', 'netCDF4','cartopy','gsw','cmocean','requests','adjusttext', 'spyder', 'xarray', 'rioxarray', 'dask', 'utm']
