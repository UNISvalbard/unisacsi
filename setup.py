...
requirements = ['matplotlib==3.5', 'glob2', 'jupyter', 'copy', 'seabird','numpy','scipy','pandas==1.2', 'geopandas', 'shapely', 'netCDF4','cartopy','gsw','cmocean','requests','adjusttext', 'spyder', 'xarray', 'rioxarray', 'dask', 'utm']
