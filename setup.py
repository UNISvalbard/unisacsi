...
setup(
  name = 'unisacsi',        
  version = '0.3.21',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/lfrankunis/unisacsi/archive/v0.3.21.tar.gz',
